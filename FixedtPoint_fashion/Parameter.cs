...
namespace AggregateLabel
{
    class Parameter
    {
        private const string version = "fixed_mnist";
        ...
        public static int lr_rsb = 13;
        public static int lr_hidden_rsb = 14;

        public const int SampleTimeWindow = 64;
        public static int[] InitTreshold = { 8 << (MemFracBits[0] + 7), 8 << (MemFracBits[1] + 7) };
