...
namespace AggregateLabel
{
    class AL_MODEL
    {
        ...
        public static int TrainNum = 60000; //实际用于训练的样本量
        public static int TestNum = 10000;
        ...
        public static Random WeightRandomHandle = new Random(20); //设置随机数种子
        public static Random UpdateRandomHandle = new Random(1);  //用于随机更新的随机种子权重
