...
namespace CODING
{
    ...
    public static class PoisionCoding
    {
        ...
        //MNIST
        public const int WriterFileTrainNum = 1968;
        public const int WriterFileTestNum = 1312;
        ...
        private const int MNISTTrainDataNum = 1968;
        private const int MNISTTestDataNum = 1312;
